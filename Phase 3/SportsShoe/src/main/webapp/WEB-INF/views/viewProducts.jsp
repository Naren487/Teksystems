...
<body>
	<div class="container">
		...
		<hr>
		<div class="container" style="display:flex;margin: 0px 67px;">
		
		 <div class="_product-images">
               <div class="picZoomer">
                  <img class="my_img" src="${product.image }" alt="">
               </div>
            
         </div>
         <div class="col-md-6" style="position:relative;left: -61vh;">
            <div class="_product-detail-content" style="position:relative;top:74px;">
               <p class="_p-name">${product.name}</p>
               <div class="_p-price-box">
                  <div class="p-list">
                     <span class="price"> M.R.P. :Rs.${product.price}</span>
                  </div>	
...
<span>Category: ${product.category }
                     ...
                     <div class="_p-qty-and-cart">
                        <div class="_p-add-cart">
                           <a class="btn-theme buttons btn buy-btn " tabindex="0" href="../payment/{${product.id}}">
