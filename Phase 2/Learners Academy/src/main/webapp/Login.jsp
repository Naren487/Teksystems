...
<nav class="navbar navbar-expand-lg bg-info navbar-dark fixed-top">
  ...
  <div class="container-fluid">
    ...
    <!-- Navbar brand -->
    <a class="navbar-brand" href="#"><strong>Learners Academy Admistrator Access</strong></a>
...
<section class="vh-100" style="position: relative;
    top: 10pc;height: 75vh!important;">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="LoginServlet" method="post">
          ...
          <div class="form-outline mb-4">
            ...
            <label class="form-label" for="form3Example3">Usename</label>
          </div>
